...
">`;
  ...
  function buildVideo(state){
    ...
    if(mode === "visible_controls"){
      return `
<video src="${esc(videoSrc)}" controls playsinline preload="metadata" poster="https://alexcaos75.github.io/Temeria-Media-Suite/assets/img/silenzio-poster.jpg" style="
