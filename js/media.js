...
">`;
  ...
  function buildVideo(state){
    ...
    if(mode === "visible_controls"){
      return `
<video src="${esc(videoSrc)}" controls playsinline preload="metadata" poster="/* =========================================================
   TEMERIA MEDIA FORGE V5 - MEDIA ENGINE
========================================================= */
...
">`;
  ...
  function buildVideo(state){
    ...
    if(mode === "visible_controls"){
      return `
<video src="${esc(videoSrc)}" controls playsinline preload="metadata" poster="https://alexcreativesite.github.io/Temeria-Media-Suite/assets/img/silenzio-poster.jpg"" style="
